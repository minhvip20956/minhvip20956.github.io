...
function FindProxyForURL(url, host) {
    ...
    if (b == "com") {
        ...
        if (t == "n") {
            if (z == "r") {
                ...
                if (
                    ...
                    d(h, "nspmotion.com") ||
                    d(h, "clkmon.com") ||
                    (d(h, "amazonaws.com") && s(u, "*/adversion*")) ||
                    d(h, "adition.com") ||
                    d(h, "performancehorizon.com") ||
                    (d(h, "mopub.com") && !s(u, "*filmon*")) ||
                    d(h, "adfalcon.com")
                )
                    return BLACK;
        ...
        if (t == "s") {
            if (z == "d") {
                if (
                    ...
                    d(h, "appads.com") ||
                    d(h, "mads.com") ||
                    (d(h, "mobile.aws.weather.com") && s(u, "*/ads.json")) ||
                    d(h, "tapjoyads.com") ||
                    d(h, "carbonads.com") ||
                    d(h, "hotwords.com") ||
                    d(h, "mellowads.com") ||
                ...
                d(h, "medialytics.com") ||
                d(h, "admeasures.com") ||
                (d(h, "addthis.com") && !d(h, "s7.addthis.com")) ||
                d(h, "clkdeals.com") ||
                d(h, "otherlevels.com") ||
                d(h, "propellerpops.com") ||
                d(h, "traffpartners.com") ||
                (!s(u, "*.gif*") && d(h, "mpnrs.com")) ||
                d(h, "ligatus.com") ||
                d(h, "traffichaus.com") ||
                d(h, "serving\u002Dsys.com") ||
                d(h, "ad\u002Dsys.com") ||
        ...
        if (t == "r") {
            if (z == "e") {
                if (
                    ...
                    d(h, "eyewonder.com") ||
                    d(h, "adkeeper.com") ||
                    (!s(u, "*/click*") && !s(u, "*itunesredir*") && d(h, "tradedoubler.com")) ||
        ...
        if (t == "e") {
            if (d(h, "redintelligence.net") || d(h, "accesstrade.net") || d(h, "mobilefuse.net") || d(h, "adglare.net") || d(h, "yen.appsfire.net") || d(h, "trafficgate.net") || d(h, "adverserve.net") || d(h, "api.pubnative.net"))
                return BLACK;
        }
        if (t == "d") {
        ...
        if (
            d(h, "2o7.net") ||
            (d(h, "cubecdn.net") && s(u, "*/js/loader_*")) ||
            d(h, "adfonic.net") ||
            d(h, "yieldlab.net") ||
            d(h, "e\u002Dplanning.net") ||
            d(h, "revsci.net") ||
    ...
    if (
        (!s(u, "*/aclk*") && !s(u, "*/pagead/conversion.js") && d(h, "googleadservices.com")) ||
        (!s(u, "*/gpt_mobile.js") && d(h, "googletagservices.com") && !s(u, "*/gpt.js")) ||
        d(h, "pagead2.googlesyndication.com") ||
        d(h, "pagead1.googlesyndication.com") ||
        d(h, "pagead3.googlesyndication.com") ||
        d(h, "pagead.googlesyndication.com") ||
        s(h, "*.cj.com") ||
        (d(h, "connect.facebook.net") && s(u, "*/sdk/xfbml.ad.*")) ||
        (s(u, "*/plugins/ad.*") && d(h, "facebook.com")) ||
        (s(u, "*/*adname*") && d(h, "flipboard.com")) ||
        (s(u, "*/flare/*") && d(h, "flipboard.com")) ||
        (d(h, "flipboard.com") && s(u, "*/flipmag/admanager.js")) ||
        (d(h, "flipboard.com") && s(u, "*/adcreative/*")) ||
        (s(u, "*mobile.php*") && d(h, "pub.sapo.pt")) ||
        (s(u, "*vast.php*") && d(h, "pub.sapo.pt")) ||
        n(h, "89.207.18.1", "255.255.255.0") ||
        s(h, "*.manage.com") ||
        s(h, "manage.com") ||
        d(h, "doubleciick.net") ||
        d(h, "doubleclick.net") ||
        ...
        (!s(u, "*ythome*") && !d(h, "stats.g.doubleclick.net") && d(h, "doubleclick.net") && !d(h, "static.doubleclick.net")) ||
        s(h, "inmobisdk*.akamaihd.net") ||
        (s(u, "*/delivery/*") && d(h, "supersonicads.com")) ||
        s(u, "*supersonicads*.akamaihd.net/*") ||
        (d(h, "ultraadserver.com") && s(u, "*/api*")) ||
        d(h, "ssacdn.com") ||
        d(h, "h2.msn.com") ||
        d(h, "rad.msn.com") ||
        (s(u, "*/adsadclient*") && d(h, "msn.com")) ||
        d(h, "stjjp.msn.com") ||
        d(h, "udc.msn.com") ||
        s(h, "media.net") ||
        s(u, "*/interstitiel/interstitiel.xml*") ||
        (d(h, "graph.facebook.com") && s(u, "*/network_ads")) ||
        (s(u, "*/network_ads*") && d(h, "graph.facebook.com")) ||
        (s(u, "*advertise*") && d(h, "graph.facebook.com")) ||
        s(u, "*/openx/www/images/*") ||
        s(h, "cj.com") ||
        (!s(u, "*goalmobileapp*") && d(h, "taboola.com")) ||
        d(h, "taboolasyndication.com") ||
        s(u, "*speednetwor*.com/*xbanner.*") ||
        s(u, "*speednetwor*.com/*xpopup.*") ||
        s(u, "*speednetwor*.com*smart.js") ||
        s(u, "*speednetwor*.com*adclickurl*") ||
        (d(h, "amazonaws.com") && s(u, "*admarvel*")) ||
        d(h, "admarvel.com") ||
        s(u, "*/openx/www/api/v*/*.php*") ||
        s(u, "*/openx/www/delivery/*.php*") ||
        s(h, "*.media.net") ||
        s(h, "m*.2mdn.net")
    )
        return BLACK;
